...
public class DiceRoller {
	...
	String finalString2 = "";
		...
		finalString2 = finalString2 + stringBuilder2.toString();
            ...
            createFiles(file1, finalString, file2, finalString2);
    ...
    public void createFiles(File file1, String finalString, File file2, String finalString2) throws IOException
    {
